...
# For H9 common enhancers
# Distal
H9_common_dist <- distal_expression(H9_common[[2]], g_exp = expression_data,
  distal_contacts = distal_contacts)

H9_common_distal_EA <- expression_analysis(H9_common_dist)

save(H9_common_distal_EA,
  file = "~/Pre_viva/Hi-C/grange_lists/H9_common_distal_EA.Rda")
# Proximal
H9_common_prox <- proximal_expression(sort(c(H9_common[[1]],H9_common[[3]])),
  g_exp = expression_data)

H9_common_proximal_EA <- expression_analysis(H9_common_prox)

save(H9_common_proximal_EA,
  file = "~/Pre_viva/Hi-C/grange_lists/H9_common_proximal_EA.Rda")
