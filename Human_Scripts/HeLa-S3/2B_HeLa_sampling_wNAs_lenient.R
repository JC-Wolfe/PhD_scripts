...
load("~/Human_Datasets/HeLa/DMRcaller_norm_tiled_DNAse_lenient.Rda")
...
save(HeLa_input_500k, file = "~/Human_Datasets/HeLa/HeLa_NAs_input_lenient.Rda")
write.csv(HeLa_input_500k, file = "~/Human_Datasets/HeLa/HeLa_NAs_input_lenient.csv",
  row.names = F)

# And the holdout files
save(HeLa_unseen_500k, file = "~/Human_Datasets/HeLa/HeLa_NAs_holdout_lenient.Rda")
write.csv(HeLa_unseen_500k, file = "~/Human_Datasets/HeLa/HeLa_NAs_holdout_lenient.csv",
  row.names = F)
