...
load("~/Project1/data/S2_enriched_contacts_GR.Rda") # gr_contacts
load("~/Paper_replots/Objects/dm6_annotation.Rda") # dm6_annotation
...
save(gr_contacts, file = "~/Paper_replots/Objects/Contact_Maps/useful_HiC_dm6_contactMap_S2.Rda")
