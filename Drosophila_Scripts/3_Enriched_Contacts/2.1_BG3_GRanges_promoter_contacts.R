...
load("~/Project1/data/BG3_enriched_contacts_GR.Rda") # gr_contacts
load("~/Paper_replots/Objects/dm6_annotation.Rda")
...
save(gr_contacts, file = "~/Paper_replots/Objects/Contact_Maps/useful_HiC_dm6_contactMap_BG3.Rda")
