...
BG3_gr_contacts <- get(load("~/Paper_replots/Objects/Contact_Maps/useful_HiC_dm6_contactMap_BG3.Rda"))
...
ann_genome <- get(load(file = "~/Paper_replots/Objects/dm6_annotation.Rda"))
...
save(BG3_putative, file = "~/Paper_replots/Objects/Class_split_glists/BG3_putative_list.Rda")
save(BG3_shared, file = "~/Paper_replots/Objects/Class_split_glists/BG3_shared_list.Rda")
save(BG3_starr_res, file = "~/Paper_replots/Objects/Class_split_glists/BG3_starr_res_list.Rda")
save(BG3_bg, file = "~/Paper_replots/Objects/Class_split_glists/BG3_bg_list.Rda")
...
S2_gr_contacts <- get(load("~/Paper_replots/Objects/Contact_Maps/useful_HiC_dm6_contactMap_S2.Rda"))
...
save(S2_putative, file = "~/Paper_replots/Objects/Class_split_glists/S2_putative_list.Rda")
save(S2_shared, file = "~/Paper_replots/Objects/Class_split_glists/S2_shared_list.Rda")
save(S2_starr_res, file = "~/Paper_replots/Objects/Class_split_glists/S2_starr_res_list.Rda")
save(S2_bg, file = "~/Paper_replots/Objects/Class_split_glists/S2_bg_list.Rda")
