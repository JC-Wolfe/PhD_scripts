...
gr_contacts <- get(load("~/Paper_replots/Objects/Contact_Maps/useful_HiC_dm6_contactMap_BG3.Rda"))
...
save(p5k, file = "~/Paper_replots/Objects/BG3_over5k_contacts.Rda")
save(p_under5k, file = "~/Paper_replots/Objects/BG3_under5k_contacts.Rda")
