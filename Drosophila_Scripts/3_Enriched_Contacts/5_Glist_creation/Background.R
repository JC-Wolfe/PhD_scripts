...
save(BG3_bg_dist, file = "~/Paper_replots/Objects/Full_glists/bg/BG3_bg_dist.Rda")
# Proximal
BG3_bg_prox <- proximal_expression(sort(c(BG3_bg[[1]],BG3_bg[[3]])),
  g_exp = expression_data, line = "BG3")
save(BG3_bg_prox, file = "~/Paper_replots/Objects/Full_glists/bg/BG3_bg_prox.Rda")

# For S2 bg enhancers
# Distal
S2_bg_dist <- distal_expression(S2_bg[[2]], g_exp = expression_data,
  distal_contacts = S2_distal_contacts, line = "S2")
save(S2_bg_dist, file = "~/Paper_replots/Objects/Full_glists/bg/S2_bg_dist.Rda")
# Proximal
S2_bg_prox <- proximal_expression(sort(c(S2_bg[[1]],S2_bg[[3]])),
  g_exp = expression_data, line = "S2")
save(S2_bg_prox, file = "~/Paper_replots/Objects/Full_glists/bg/S2_bg_prox.Rda")
