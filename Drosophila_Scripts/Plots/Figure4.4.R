...
png("/home/jw18713/Project1/Paper_Plots/FigureS1/Supp_Figure1A.png", pointsize = 14,
width=1200, height=1200, res = 200)
plot(BG3_roc, main = "BG3 ROC")
dev.off()

png("/home/jw18713/Project1/Paper_Plots/FigureS1/Supp_Figure1B.png", pointsize = 14,
width=1200, height=1200, res = 200)
plot(BG3_pr, main = "BG3 PRC")
dev.off()

png("/home/jw18713/Project1/Paper_Plots/FigureS1/Supp_Figure1C.png", pointsize = 14,
width=1200, height=1200, res = 200)
plot(S2_roc, main = "S2 ROC")
dev.off()

png("/home/jw18713/Project1/Paper_Plots/FigureS1/Supp_Figure1D.png", pointsize = 14,
width=1200, height=1200, res = 200)
