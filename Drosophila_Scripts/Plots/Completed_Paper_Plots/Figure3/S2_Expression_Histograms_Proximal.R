...
load("/home/Archive_Year1/S2_novel_proximal.Rda")
...
list_proximal_enhancers <- split(S2_novel_proximal, as.factor(S2_novel_proximal))
...
new <- Sys.time()
print(old - new)
save(proximal_enhancers_glist, file = "/home/jw18713/Project1/Paper_Rda_Stuff/S2/proximal_enhancer_glist.Rda")
...
pdf(file = "/home/jw18713/Project1/Paper_Plots/Figure3/S2/S2_Proximal_Enhancers_Zero_Expression_Barplot_Median.pdf")
...
pdf(file = "/home/jw18713/Project1/Paper_Plots/Figure3/S2/S2_Proximal_Enhancers_Zero_Expression_Barplot_Max.pdf")
...
pdf(file = "/home/jw18713/Project1/Paper_Plots/Figure3/S2/S2_Proximal_Enhancer_Expression_Histogram.pdf")
hist(log2(expression_max+1), main="S2 Proximal Enhancers\nMax Contacted Expression", xlab="Expression FPKM", col="lightblue", cex.main=2, cex.lab=1.5, axes=F, ylim = c(0,3000))
