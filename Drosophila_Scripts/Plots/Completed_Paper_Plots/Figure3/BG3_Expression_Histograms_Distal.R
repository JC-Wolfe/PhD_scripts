...
# loading distal_only
load("/home/Archive_Year1/BG3_novel_distal.Rda")
...
list_distal_only <- split(BG3_novel_distal, as.factor(BG3_novel_distal))
...
new <- Sys.time()
print(old - new)
save(distal_only_glist, file = "/home/jw18713/Project1/Paper_Rda_Stuff/BG3/distal_only_glist.Rda")
...
pdf(file = "/home/jw18713/Project1/Paper_Plots/Figure3/BG3/BG3_Distal_Enhancers_Zero_Expression_Barplot_Median.pdf")
...
pdf(file = "/home/jw18713/Project1/Paper_Plots/Figure3/BG3/BG3_Distal_Enhancers_Zero_Expression_Barplot_Max.pdf")
...
pdf(file = "/home/jw18713/Project1/Paper_Plots/Figure3/BG3/BG3_Distal_Enhancer_Expression_Histogram.pdf")
hist(log2(expression_max+1), main="BG3 Distal Only\nMax Contacted Expression", xlab="Expression FPKM", col="lightblue", cex.main=2, cex.lab=1.5, axes=F, ylim = c(0,3000))
