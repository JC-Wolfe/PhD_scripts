...
load("/home/jw18713/Archive_Year1/grown_predicted_enhancers_BG3.Rda") # pred_enh
...
load("/home/jw18713/Archive_Year1/starr.Rda") # as starr
...
save(enhancers_neither, file = "/home/jw18713/Project1/Paper_Rda_Stuff/BG3/Pred_Enh_No_Promoter_Overlaps.Rda")
save(starr_neither, file = "/home/jw18713/Project1/Paper_Rda_Stuff/BG3/Starr_No_Promoter_Overlaps.Rda")
save(proximal_enhancers, file = "/home/jw18713/Project1/Paper_Rda_Stuff/BG3/Proximal_Enhancers.Rda")
save(distal_only, file = "/home/jw18713/Project1/Paper_Rda_Stuff/BG3/Distal_Only_Enhancers.Rda")
save(distal_enhancers, file = "/home/jw18713/Project1/Paper_Rda_Stuff/BG3/All_Distal_Enhancers.Rda")
save(starr, file = "/home/jw18713/Project1/Paper_Rda_Stuff/BG3/starr.Rda")
save(p5k, file = "/home/jw18713/Project1/Paper_Rda_Stuff/BG3/over5k_contacts.Rda")
save(p_under5k, file = "/home/jw18713/Project1/Paper_Rda_Stuff/BG3/under5k_contacts.Rda")
save(shared_distal_enhancers, file = "/home/jw18713/Project1/Paper_Rda_Stuff/BG3/shared_distal_enhancers.Rda")
save(shared_proximal_enhancers, file = "/home/jw18713/Project1/Paper_Rda_Stuff/BG3/shared_proximal_enhancers.Rda")
save(shared_neither, file = "/home/jw18713/Project1/Paper_Rda_Stuff/BG3/shared_neither.Rda")
save(shared_distal_only, file = "/home/jw18713/Project1/Paper_Rda_Stuff/BG3/shared_distal_only.Rda")
...
pdf("/home/jw18713/Project1/Paper_Plots/Figure3/BG3/BG3_Enhancer_VennDiagram.pdf")
plot.new()
v1 <- generateTripleVenn(distal_enhancers, proximal_enhancers, enhancers_neither, c("Distal\nPromoter", "Proximal\nPromoter", "Neither"),
                           ...
                           human = F)
title(main = "BG3 Novel Enhancer/Promoter Overlaps")
dev.off()


# Distal Enhancers
pdf("/home/jw18713/Project1/Paper_Plots/Figure3/BG3/BG3_Distal_Only_Enhancer_Widths.pdf")
hist(log2(width(distal_only)), axes=F, main="BG3 Novel Distal Only Enhancer Widths", xlab="Width (bp)", col="lightblue", cex.main=2, cex.lab=1.5, xlim = c(3,14), ylim = c(0,1500))
...
# Proximal Enhancer
pdf("/home/jw18713/Project1/Paper_Plots/Figure3/BG3/BG3_Proximal_Enhancer_Widths.pdf")
hist(log2(width(proximal_enhancers)), axes=F, main="BG3 Novel Proximal Enhancer Widths", xlab="Width (bp)", col="lightblue", cex.main=2, cex.lab=1.5, xlim = c(3,14), ylim = c(0,1500))
axis(1, at=seq(3,14, by = 1), labels=2^seq(3,14,by=1))
axis(2, at=seq(0,1500, by = 250), labels = seq(0,1500, by = 250))
abline(v = log2(50), col="red", lty=2, lwd=2)
abline(v = log2(1000), col="red", lty=2, lwd=2)
