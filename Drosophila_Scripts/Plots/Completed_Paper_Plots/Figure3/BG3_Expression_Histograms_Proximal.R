...
load("/home/Archive_Year1/BG3_novel_proximal.Rda")
...
list_proximal_enhancers <- split(BG3_novel_proximal, as.factor(BG3_novel_proximal))
...
new <- Sys.time()
print(old - new)
save(proximal_enhancers_glist, file = "/home/jw18713/Project1/Paper_Rda_Stuff/BG3/proximal_enhancers_glist.Rda")
...
pdf(file = "/home/jw18713/Project1/Paper_Plots/Figure3/BG3/BG3_Proximal_Enhancers_Zero_Expression_Barplot_Median.pdf")
...
pdf(file = "/home/jw18713/Project1/Paper_Plots/Figure3/BG3/BG3_Proximal_Enhancers_Zero_Expression_Barplot_Max.pdf")
...
pdf(file = "/home/jw18713/Project1/Paper_Plots/Figure3/BG3/BG3_Proximal_Enhancer_Expression_Histogram.pdf")
hist(log2(expression_max+1), main="BG3 Proximal Enhancers\nMax Contacted Expression", xlab="Expression FPKM", col="lightblue", cex.main=2, cex.lab=1.5, axes=F, ylim = c(0,3000))
