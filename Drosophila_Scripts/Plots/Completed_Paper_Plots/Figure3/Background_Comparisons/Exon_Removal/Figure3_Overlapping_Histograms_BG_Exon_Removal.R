...
pdf(file = "/home/jw18713/Project1/Paper_Plots/Figure3/Figure3D_max_noexons.pdf",
...
# Ok, so this is my histogram then
pdf(file = "/home/jw18713/Project1/Paper_Plots/Figure3/Figure3_mean_noexons.pdf",
width = 14, height = 12, pointsize = 14)
par(mar=c(4.9,5.5,5.5,8), mfrow=c(2,2), cex = 1.2)
par(xpd = NA)
