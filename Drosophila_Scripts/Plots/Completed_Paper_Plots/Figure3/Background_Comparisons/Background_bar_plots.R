...
BG3_gr_contacts <- get(load("/home/jw18713/Archive_Year1/useful_HiC_dm6_contactMap.Rda"))
...
BG3_400 <- get(load("/home/jw18713/Archive_Year1/empty_400bp_background.Rda"))
...
rownames(BG3_mat) <- c("Putative", "Shared", "STARR-seq", "Background")
...
S2_gr_contacts <- get(load("/home/jw18713/Archive_Year1/useful_HiC_dm6_contactMap_S2.Rda"))
...
S2_400 <- get(load("/home/jw18713/Archive_Year1/empty_400bp_background.Rda"))
...
S2_mat <- matrix(0,4,4)
rownames(S2_mat) <- c("Putative", "Shared", "STARR-seq", "Background")
...
pdf(paste0("/home/jw18713/Project1/Paper_Plots/Figure3/Figure3_Contact_Type_Barplot_", t, ".pdf",)
...
hmap <- BG3_bar
hmap_aves <- BG3_bar_aves


hmap_comp <- hmap_aves[,1:3]
hmap_comp[1,] <- log2(hmap_comp[1,]/hmap_aves[1,4])
hmap_comp[2,] <- log2(hmap_comp[2,]/hmap_aves[2,4])
hmap_comp[3,] <- log2(hmap_comp[3,]/hmap_aves[3,4])

hmap <- S2_bar
hmap_aves <- S2_bar_aves
...
cbbPalette <- c("#000000", "#E69F00", "#56B4E9", "#009E73", "#F0E442", "#0072B2", "#D55E00", "#CC79A7")
custom_at <- seq(-1, 1, by = (2/30))
cols_contrast <- rev(c(colorRampPalette(c(cbbPalette[7], "white", cbbPalette[6]))(30)))



pdf(paste0("/home/jw18713/Project1/Paper_Plots/Figure3/Figure3_Contact_Enrichment_HM_", t, "pdf"))
  levelplot(hmap_comp,
    at = custom_at,
