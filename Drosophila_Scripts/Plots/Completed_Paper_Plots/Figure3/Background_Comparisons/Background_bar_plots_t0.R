...
save(BG3_putative, file = "BG3_putative_list.Rda")
save(BG3_shared, file = "BG3_shared_list.Rda")
save(BG3_starr_res, file = "BG3_starr_res_list.Rda")
save(BG3_bg, file = "BG3_bg_list.Rda")
...
save(S2_putative, file = "S2_putative_list.Rda")
save(S2_shared, file = "S2_shared_list.Rda")
save(S2_starr_res, file = "S2_starr_res_list.Rda")
save(S2_bg, file = "S2_bg_list.Rda")
