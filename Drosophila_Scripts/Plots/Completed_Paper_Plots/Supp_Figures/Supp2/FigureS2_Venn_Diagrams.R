...
BG3_shared_distal <- get(load("/home/jw18713/Project1/Paper_Rda_Stuff/BG3/shared_distal_enhancers.Rda"))
BG3_shared_neither <- get(load("/home/jw18713/Project1/Paper_Rda_Stuff/BG3/shared_neither.Rda"))


v1 <- generateTripleVenn(BG3_shared_distal, BG3_shared_proximal, BG3_shared_neither, c("Distal\nPromoter", "Proximal\nPromoter", "Neither"),
...
S2_shared_distal <- get(load("/home/jw18713/Project1/Paper_Rda_Stuff/S2/shared_distal_enhancers.Rda"))
S2_shared_neither <- get(load("/home/jw18713/Project1/Paper_Rda_Stuff/S2/shared_neither.Rda"))


v2 <- generateTripleVenn(S2_shared_distal, S2_shared_proximal, S2_shared_neither, c("Distal\nPromoter", "Proximal\nPromoter", "Neither"),
                           cols=c(cbbPalette[6], cbbPalette[7], cbbPalette[8]),
                           cat.pos = c(-60, 60, 180),
                           cat.dist = c(0.125, 0.125, 0.05),
                           human = F)

pdf("/home/jw18713/Project1/Paper_Plots/FigureS3/FigureS3A.pdf", width=8, height=5,pointsize = 10);
