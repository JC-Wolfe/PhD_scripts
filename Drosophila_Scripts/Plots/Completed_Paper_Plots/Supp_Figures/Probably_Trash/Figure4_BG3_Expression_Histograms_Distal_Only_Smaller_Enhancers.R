...
new <- Sys.time()
print(old - new)
save(distal_only_glist, file = "/home/jw18713/Project1/Paper_Rda_Stuff/BG3/distal_only_standard_enhancer_glist_SE.Rda")
...
pdf(file = "/home/jw18713/Project1/Paper_Plots/Figure4/BG3/BG3_Distal_Standard_Enhancers_Zero_Expression_Barplot_Median.pdf")
...
pdf(file = "/home/jw18713/Project1/Paper_Plots/Figure4/BG3/BG3_Distal_Standard_Enhancers_Zero_Expression_Barplot_Max.pdf")
...
pdf(file = "/home/jw18713/Project1/Paper_Plots/Figure4/BG3/BG3_Distal_Standard_Enhancer_Expression_Histogram.pdf")
hist(log2(expression_max+1), main="BG3 Distal Only Standard Enhancers\nMax Contacted Expression", xlab="Expression FPKM", col="lightblue", cex.main=2, cex.lab=1.5, axes=F, xlim = c(0,15), ylim = c(0,3000))
