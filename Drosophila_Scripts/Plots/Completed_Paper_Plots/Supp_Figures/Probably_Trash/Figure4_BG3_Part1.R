...
pdf("/home/jw18713/Project1/Paper_Plots/Figure4/BG3/BG3_Super_Enhancer_VennDiagram.pdf")
plot.new()
v1 <- generateTripleVenn(distal_enhancers_SE, proximal_enhancers_SE, enhancers_neither_SE, c("Distal\nPromoter", "Proximal\nPromoter", "Neither"),
                           ...
                           human = F)
title(main = "BG3 Novel Super Enhancer/Promoter Overlaps")
dev.off()


# Distal Enhancers
pdf("/home/jw18713/Project1/Paper_Plots/Figure4/BG3/BG3_Distal_Only_Super_Enhancer_Widths.pdf")
hist(width(distal_only_SE), axes=F, main="BG3 Novel Distal Only\nSuper Enhancer Widths", xlab="Width (bp)", col="lightblue", cex.main=2, cex.lab=1.5, xlim = c(1000,15000), ylim = c(0,1000))
axis(1, at=seq(1000,15000, by = 1000), labels=seq(1000,15000,by=1000))
axis(2, at=seq(0,1000, by = 100), labels = seq(0,1000, by = 100))
dev.off()

# Proximal Enhancer
pdf("/home/jw18713/Project1/Paper_Plots/Figure4/BG3/BG3_Proximal_Super_Enhancer_Widths.pdf")
hist(width(proximal_enhancers_SE), axes=F, main="BG3 Novel Proximal\nSuper Enhancer Widths", xlab="Width (bp)", col="lightblue", cex.main=2, cex.lab=1.5, xlim = c(1000,15000), ylim = c(0,1000))
axis(1, at=seq(1000,15000, by = 1000), labels=seq(1000,15000,by=1000))
axis(2, at=seq(0,1000, by = 100), labels = seq(0,1000, by = 100))
dev.off()
