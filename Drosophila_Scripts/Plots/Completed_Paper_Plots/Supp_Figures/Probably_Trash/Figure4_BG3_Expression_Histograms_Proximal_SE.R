...
proximal_enhancers <- proximal_enhancers[width(proximal_enhancers) >= 1000] # Just checking super enhancers
...
new <- Sys.time()
print(old - new)
save(proximal_enhancers_glist, file = "/home/jw18713/Project1/Paper_Rda_Stuff/BG3/proximal_super_enhancer_glist.Rda")
...
pdf(file = "/home/jw18713/Project1/Paper_Plots/Figure4/BG3/BG3_Proximal_Super_Enhancers_Zero_Expression_Barplot_Median.pdf")
...
pdf(file = "/home/jw18713/Project1/Paper_Plots/Figure4/BG3/BG3_Proximal_Super_Enhancers_Zero_Expression_Barplot_Max.pdf")
...
pdf(file = "/home/jw18713/Project1/Paper_Plots/Figure4/BG3/BG3_Proximal_Super_Enhancer_Expression_Histogram.pdf")
hist(log2(expression_max+1), main="BG3 Proximal Super Enhancers\nMax Contacted Expression", xlab="Expression FPKM", col="lightblue", cex.main=2, cex.lab=1.5, axes=F, ylim = c(0,500))
