...
new <- Sys.time()
print(old - new)
save(distal_only_glist, file = "/home/jw18713/Project1/Paper_Rda_Stuff/S2/distal_only_glist_SE.Rda")
...
pdf(file = "/home/jw18713/Project1/Paper_Plots/Figure4/S2/S2_Distal_Super_Enhancers_Zero_Expression_Barplot_Median.pdf")
...
pdf(file = "/home/jw18713/Project1/Paper_Plots/Figure4/S2/S2_Distal_Super_Enhancers_Zero_Expression_Barplot_Max.pdf")
...
pdf(file = "/home/jw18713/Project1/Paper_Plots/Figure4/S2/S2_Distal_Super_Enhancer_Expression_Histogram.pdf")
hist(log2(expression_max+1), main="S2 Distal Only Super Enhancers\nMax Contacted Expression", xlab="Expression FPKM", col="lightblue", cex.main=2, cex.lab=1.5, axes=F, ylim = c(0,500))
