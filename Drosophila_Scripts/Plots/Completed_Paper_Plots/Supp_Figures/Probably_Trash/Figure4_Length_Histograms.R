...
pdf(file = "/home/jw18713/Project1/Paper_Plots/Figure3/Figure3C-F.pdf",
width = 32, height = 8, pointsize = 14)
par(mar=c(5,4.5,5,4), mfrow=c(1,4), cex = 1.2)
par(xpd = NA)

      # BG3 proximal
      hist(log2(width(BG3_novel_proximal)), axes=F, main="BG3 Proximal\nNovel Enhancer Widths",
        xlab="Width (bp)", col="#56B4E9", cex.main=2, cex.lab=1.5, xlim = c(3,14), ylim = c(0,1500),
        breaks = 20)
      ...
      #BG3 distal only
      hist(log2(width(BG3_novel_distal)), axes=F, main="BG3 Distal Only\nNovel Enhancer Widths",
        xlab="Width (bp)", col="#56B4E9", cex.main=2, cex.lab=1.5, xlim = c(3,14), ylim = c(0,1500),
        breaks = 20)
          axis(1, at=c(log2(10), log2(50), log2(150), log2(400), log2(1000), log2(4000), log2(16000)),
              labels=c(10, 50, 150, 400, 1000, 4000, 16000))
      ...
      #S2 proximal
      hist(log2(width(S2_novel_proximal)), axes=F, main="S2 Proximal\nNovel Enhancer Widths",
        xlab="Width (bp)", col="#56B4E9", cex.main=2, cex.lab=1.5, xlim = c(3,14), ylim = c(0,1500),
        breaks = 20)
          axis(1, at=c(log2(10), log2(50), log2(150), log2(400), log2(1000), log2(4000), log2(16000)),
              labels=c(10, 50, 150, 400, 1000, 4000, 16000))
      ...
      #S2 distal only
      hist(log2(width(S2_novel_distal)), axes=F, main="S2 Distal Only\n Novel Enhancer Widths",
        xlab="Width (bp)", col="#56B4E9", cex.main=2, cex.lab=1.5, xlim = c(3,14), ylim = c(0,1500),
        breaks = 20)
          axis(1, at=c(log2(10), log2(50), log2(150), log2(400), log2(1000), log2(4000), log2(16000)),
              labels=c(10, 50, 150, 400, 1000, 4000, 16000))
