...
pdf(file = "/home/jw18713/Project1/Paper_Plots/FigureS4/FigureS4D.pdf",
...
hist(log2(expression_max_BG3D+1), main="BG3 Enhancers\nMax Contacted Expression",
  ...
  ylim = c(0,600), breaks = seq(0,16, by = 1), ylab = NA)
axis(1, at=seq(0,16,by=4), labels=c(0,2^seq(4,16, by = 4)))
axis(2, at=seq(0,600, by = 150), labels = seq(0,600, by = 150), las=2)

hist(log2(expression_max_BG3P+1), col="#D55E0080", add=T, breaks = 16)

legend(16.5,400,c("Distal", "Proximal"), fill=c("#0072B280", "#D55E0080"), bty='n')
...
# Ok, so this is my histogram then
pdf(file = "/home/jw18713/Project1/Paper_Plots/FigureS4/FigureS4Dmeans.pdf",
width = 14, height = 6, pointsize = 14)
