...
BG3_starr_neither <- get(load("/home/jw18713/Project1/Paper_Rda_Stuff/BG3/starr_neither.Rda"))
BG3_distal_starr <- get(load("/home/jw18713/Project1/Paper_Rda_Stuff/BG3/distal_starr.Rda"))
BG3_proximal_starr <- get(load("/home/jw18713/Project1/Paper_Rda_Stuff/BG3/proximal_starr.Rda"))

v1 <- generateTripleVenn(BG3_distal_starr, BG3_proximal_starr, BG3_starr_neither, c("Distal\nPromoter", "Proximal\nPromoter", "Neither"),
                           cols=c(cbbPalette[6], cbbPalette[7], cbbPalette[8]),
                           cat.pos = c(-60, 60, 180),
                           cat.dist = c(0.125, 0.125, 0.05),
                           human = F)

S2_starr_neither <- get(load("/home/jw18713/Project1/Paper_Rda_Stuff/S2/starr_neither.Rda"))
S2_distal_starr <- get(load("/home/jw18713/Project1/Paper_Rda_Stuff/S2/distal_starr.Rda"))
S2_proximal_starr <- get(load("/home/jw18713/Project1/Paper_Rda_Stuff/S2/proximal_starr.Rda"))

v2 <- generateTripleVenn(S2_distal_starr, S2_proximal_starr, S2_starr_neither, c("Distal\nPromoter", "Proximal\nPromoter", "Neither"),
                           cols=c(cbbPalette[6], cbbPalette[7], cbbPalette[8]),
                           cat.pos = c(-60, 60, 180),
                           cat.dist = c(0.125, 0.125, 0.05),
                           human = F)

pdf("~/Project1/Paper_Plots/FigureS4/FigureS4A.pdf", width=8, height=5,pointsize = 10);
