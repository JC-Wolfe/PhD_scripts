...
save(BG3_put_dist, file = "~/rerun_glists/putative/BG3_put_dist.Rda")
# Proximal
BG3_put_prox <- proximal_expression(sort(c(BG3_putative[[1]],BG3_putative[[3]])),
  g_exp = expression_data, line = "BG3")
save(BG3_put_prox, file = "~/rerun_glists/putative/BG3_put_prox.Rda")
...
save(S2_put_dist, file = "~/rerun_glists/putative/S2_put_dist.Rda")
# Proximal
S2_put_prox <- proximal_expression(sort(c(S2_putative[[1]],S2_putative[[3]])),
  g_exp = expression_data, line = "S2")
save(S2_put_prox, file = "~/rerun_glists/putative/S2_put_prox.Rda")
