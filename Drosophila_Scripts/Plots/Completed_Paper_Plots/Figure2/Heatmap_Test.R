...
S2_results <- get(load("~/P1_Full_Run/Model_outputs/S2_XAI.Rda"))
BG3_results <- get(load("~/P1_Full_Run/Model_outputs/BG3_XAI.Rda"))
marks <- mcols(S2_results)[1:26]
S2_enhancers <- get(load("~/P1_Full_Run/Model_outputs/Thresh_outputs/Threshold_0.8/S2_t80_S2_trained"))
