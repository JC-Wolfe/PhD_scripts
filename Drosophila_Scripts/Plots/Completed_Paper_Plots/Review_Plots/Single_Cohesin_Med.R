...
rules <- read.csv("Single_Cohesin_Med_Rules.csv",
  stringsAsFactors = F)
...
features <- read.csv("Single_Cohesin_Med_Features.csv", stringsAsFactors = F)
...
pdf("Single_Cohesin_Med_Common.pdf",
...
pdf("Single_Cohesin_Med_Putative.pdf",
