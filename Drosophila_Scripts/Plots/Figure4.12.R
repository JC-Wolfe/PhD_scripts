...
load("~/Paper_replots/Objects/Neither_matrix.Rda")
...
write.csv(BG3_all_stats,
  file = "~/Paper_replots/Stats/3C_stats/BG3_All.csv")
...
write.csv(BG3_d_stats,
  file = "~/Paper_replots/Stats/3C_stats/BG3_Distal_Only.csv")
...
write.csv(BG3_pr_stats,
  file = "~/Paper_replots/Stats/3C_stats/BG3_Proximal.csv")
...
write.csv(S2_all_stats,
  file = "~/Paper_replots/Stats/3C_stats/S2_All.csv")
...
write.csv(S2_d_stats,
  file = "~/Paper_replots/Stats/3C_stats/S2_Distal_Only.csv")
...
write.csv(S2_pr_stats,
  file = "~/Paper_replots/Stats/3C_stats/S2_Proximal.csv")
...
pdf(file = "~/Paper_replots/Plots/Figure3C.pdf", width = 21,
