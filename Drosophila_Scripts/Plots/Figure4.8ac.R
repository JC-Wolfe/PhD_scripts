...
ann_genome <- get(load("~/Paper_replots/Objects/dm6_annotation.Rda"))
...
pdf("~/Paper_replots/Plots/Figure2/BG3_ann_bars.pdf")
...
hmap_comp[hmap_comp > 2.5] <- 2.5
hmap_comp[hmap_comp < -2.5] <- -2.5
cols_contrast <- rev(c(colorRampPalette(c(cbbPalette[7], "white", cbbPalette[6]))(30)))


pdf(file = "~/Paper_replots/Plots/Figure2/BG3_ann_hmap.pdf")
